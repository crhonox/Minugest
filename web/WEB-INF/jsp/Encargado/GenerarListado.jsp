        ...
        <div id="sidebara" class="nav-collapse">
         ...
         <div class="menu-conte-wra">
            <div class="row">
                ...
                <li class="active"> Generar lista de Insumos</li>
                </ol>
                    </div>
                    <div class="panel-body">
                        <p>
                            Para generar un listado de insumos usted debe ingresar el rango de fecha del cual quiere seleccionar las minutas <br>
                                    ejemplo: Minutas de mayo <br>
                                    Fecha Inicio : 2017-05-01<br>
