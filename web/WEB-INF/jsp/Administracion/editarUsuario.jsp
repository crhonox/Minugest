        ...
        <div class="menu-conte-wra">
            <div class="row">
                ...
                <form:form method="POST" commandName="usuario">
                    ...
                    <p><form:label path="RutEmpresa">Rut Empresa :</form:label>
                        <form:input readonly="true" path="RutEmpresa" cssClass="form-control"/></p>
                    <form:label path="rut">Rut  :</form:label>
                    <form:input readonly="true" path="rut" cssClass="form-control"/>
